...
public class UserService {
    ...
    public User updateProfile(UUID userId, User updates) {
        ...
        if (updates.getPreferredLanguage() != null) user.setPreferredLanguage(updates.getPreferredLanguage());
    ...
    public Address updateAddress(UUID userId, UUID addressId, Address updates) {
        ...
        if (updates.getAddressLine1() != null) address.setAddressLine1(updates.getAddressLine1());
        if (updates.getAddressLine2() != null) address.setAddressLine2(updates.getAddressLine2());
