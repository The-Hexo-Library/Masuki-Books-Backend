...
public class UserController {
    ...
    @PreAuthorize("hasAnyRole('user','admin','superadmin')")
    public ResponseEntity<ApiResponse<List<Address>>> getAddresses(@RequestHeader("Authorization") String authHeader) {
        UUID userId = getCurrentUserId(authHeader);
        return ResponseEntity.ok(ApiResponse.success("Addresses retrieved", userService.getAddresses(userId)));
    }
